...
<div class="bg-modal-comments d-none">
    <div class="close-btn">
        <a href="javascript:void(0)"><img src="{{ asset('frontend/img/cancel.png') }}"></a>
    </div>
    <div class="modal-content-area-comments">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <!-- <form action="{{ route('videoSearch') }}" method="POST"> -->
                                        <div class="video-search">
                                            <input type="text" placeholder="{{ __('Video Search') }}" oninput="videoSearch()" id="videoSearch" autocomplete="off">
                                            <input type="hidden" id="videoSearch_url" value="{{ route('videoSearch') }}">
                    ...
                    @csrf
                    <div class="row grid video-panel">
                        @if(!$videos==null)
...
<input type="hidden" id="commentPopuUp_url" value="{{ route('commentPopUp') }}">
