                ...
                <div class="col-lg-6">
                    <div class="header-search-area">
                        <div class="header-searchbox text-center">
                            <input type="text" placeholder="{{ __('User Search') }}" id="userSearch" oninput="userSearch()" autocomplete="off">
                            <input type="hidden" id="search_url" value="{{ route('userSearch') }}">
                    ...
                    <div class="header-right-section f-right">
                        ...
                        <div class="profile-seeting">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a  href="{{ route('cartegory.show', Auth::User()->slug) }}" class="pjax dropdown-item">Cartegory</a>
