...
Route::get('/commentPopUp','PopupController@commentPopUp')->name('commentPopUp')->middleware('two_factor');
Route::get('/popup2','PopupController@popup2')->name('popup2')->middleware('two_factor');
...
// search routes
Route::get('userSearch','SearchController@userSearch')->name('userSearch');
Route::get('videoSearch', 'SearchController@videoSearch')->name('videoSearch');
Route::get('videoSearch_cart', 'SearchController@videoSearch_cart')->name('videoSearch_cart');
...
Route::group(['middleware'=>['auth','two_factor']],function(){
	...
	Route::get('like2','LikeController@like2')->name('like2');
	Route::get('cartegory','LikeController@cartegory')->name('cartegory');
	Route::get('cartegory_show/{slug}','LikeController@cartegory_show')->name('cartegory.show');
	...
	Route::post('video/edit/{id}', 'UploadController@edit')->name('video.edit');
	Route::get('approve','LikeController@videoApprove')->name('approve');
	Route::post('video/update/{id}', 'UploadController@videoUpdate')->name('video.update');

	Route::post('post/store','UploadController@store')->name('post.store');
	Route::post('post/update/{id}','UploadController@storeUpdate')->name('post.update');
	...
	Route::post('user/{id}','SettingsController@video_delete')->name('video.delete');
